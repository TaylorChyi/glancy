...
public class EmailVerificationProperties {
  ...
  private final EmailVerificationComplianceProperties compliance =
      new EmailVerificationComplianceProperties();
  ...
  private final EmailVerificationStreamsProperties streams =
      new EmailVerificationStreamsProperties();
  private final EmailVerificationLocalizationProperties localization =
      new EmailVerificationLocalizationProperties();
  ...
  public void setTemplates(
      Map<EmailVerificationPurpose, EmailVerificationTemplateProperties> templates) {
  ...
  private void validateCompliance() {
    if (!StringUtils.hasText(compliance.getUnsubscribeMailto())
      ...
      throw new IllegalStateException(
          "mail.verification.compliance.unsubscribe contact must be configured");
    }
  }
