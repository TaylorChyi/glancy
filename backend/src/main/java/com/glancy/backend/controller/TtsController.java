...
public class TtsController {
    ...
    public ResponseEntity<TtsResponse> synthesizeWord(
            @AuthenticatedUser Long userId, HttpServletRequest httpRequest, @Valid @RequestBody TtsRequest request) {
    ...
    public ResponseEntity<TtsResponse> streamWord(
            @AuthenticatedUser Long userId, HttpServletRequest httpRequest, @ModelAttribute TtsQueryRequest query) {
