...
public class RedemptionCodeController {
  ...
  /** 意图：创建兑换码配置。 */
  @PostMapping
  public ResponseEntity<RedemptionCodeResponse> createCode(
      @Valid @RequestBody RedemptionCodeCreateRequest request) {
  ...
  public ResponseEntity<RedemptionRedeemResponse> redeem(
      @AuthenticatedUser User user, @Valid @RequestBody RedemptionRedeemRequest request) {
