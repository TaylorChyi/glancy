...
/**
 * Provides core user management operations such as registration, login and third-party account
 * binding.
 */
@Slf4j
@Service
public class UserService {
  ...
  public UserResponse register(UserRegistrationRequest req) {
    ...
    return new UserResponse(
        saved.getId(), saved.getUsername(), saved.getEmail(), saved.getAvatar(), saved.getPhone());
  }
