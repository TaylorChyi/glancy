...
public final class WordPersistenceContext {
    ...
    SaveWordStep saveWordStep() {
        return saveWordStep;
    }

    RecordSynchronizationStep recordSynchronizationStep() {
        return recordSynchronizationStep;
    }

    VersionPersistStep versionPersistStep() {
        return versionPersistStep;
    }

    PersonalizationStep personalizationStep() {
