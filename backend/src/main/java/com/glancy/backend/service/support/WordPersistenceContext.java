...
public final class WordPersistenceContext {
    ...
    private WordPersistenceContext(Builder builder) {
        ...
        this.recordSynchronizationStep =
                Objects.requireNonNull(builder.recordSynchronizationStep, "recordSynchronizationStep must not be null");
        ...
        this.wordSerializationStep =
                Objects.requireNonNull(builder.wordSerializationStep, "wordSerializationStep must not be null");
    ...
    public interface VersionPersistStep {
        SearchResultVersion persist(
                Long recordId, Long userId, String model, String content, Word word, DictionaryFlavor flavor);
    }
