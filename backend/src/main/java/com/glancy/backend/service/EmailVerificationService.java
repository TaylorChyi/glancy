...
public class EmailVerificationService {
  ...
  public void consumeCode(String email, String code, EmailVerificationPurpose purpose) {
    ...
    LocalDateTime now = LocalDateTime.now(clock);
    log.info(
        "Consuming verification code for {} with purpose {} at {}", normalizedEmail, purpose, now);
  ...
  private void invalidateExisting(
      String email, EmailVerificationPurpose purpose, LocalDateTime now) {
  ...
  public void invalidateCodes(String email, EmailVerificationPurpose purpose) {
    ...
    LocalDateTime now = LocalDateTime.now(clock);
    log.info(
        "Invalidating verification codes for {} with purpose {} at {}",
        normalizedEmail,
        purpose,
        now);
    invalidateExisting(normalizedEmail, purpose, now);
  ...
  private EmailVerificationCode loadLatestCode(
