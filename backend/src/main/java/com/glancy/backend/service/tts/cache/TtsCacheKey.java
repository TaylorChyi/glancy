...
/**
 * Utility for computing cache keys used to deduplicate synthesis
 * requests. The hash is stable across environments so that existing
 * cache entries remain reusable over time.
 */
