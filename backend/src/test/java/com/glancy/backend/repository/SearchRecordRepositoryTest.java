...
class SearchRecordRepositoryTest {
    ...
    void ordersActiveRecordsByUpdatedAt() {
        ...
        List<SearchRecord> list =
                searchRecordRepository.findByUserIdAndDeletedFalseOrderByUpdatedAtDesc(fixture.user.getId());
    ...
    void excludesSoftDeletedRecords() {
        SearchRecordFixture fixture = seedRecords();
        Assertions.assertTrue(searchRecordRepository
                .findByIdAndDeletedFalse(fixture.activeTerm1.getId())
                .isPresent());
        Assertions.assertTrue(searchRecordRepository
                .findByIdAndDeletedFalse(fixture.activeTerm2.getId())
                .isPresent());
        Assertions.assertTrue(searchRecordRepository
                .findByIdAndDeletedFalse(fixture.deleted.getId())
                .isEmpty());
    }
