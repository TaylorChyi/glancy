...
class VerificationEmailComposerTest {
    ...
    void populate_shouldComposeMultipartMessageWithComplianceHeaders() throws Exception {
        ...
        VerificationEmailContentResolver resolver = (ip, code) -> new LocalizedVerificationContent(
                "验证码：" + code,
        ...
        composer.populate(
                message, "user@example.com", EmailVerificationPurpose.LOGIN, "123456", expiresAt, "198.51.100.1");
