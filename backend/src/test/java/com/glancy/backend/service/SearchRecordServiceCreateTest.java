...
class SearchRecordServiceCreateTest extends AbstractSearchRecordServiceTest {
  ...
  void reusedRecordRefreshesUpdatedAtAndMovesToTop() throws InterruptedException {
    ...
    SearchRecordResponse alphaRecord =
        searchRecordService.saveRecord(user.getId(), request("alpha"));
    ...
    Assertions.assertTrue(
        refreshedAlpha.getUpdatedAt().isAfter(beforeReuse), "复用后的记录应刷新 updatedAt 以反映最近访问");
