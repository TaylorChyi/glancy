...
class KeyboardShortcutServiceTest {
  ...
  @Autowired private KeyboardShortcutService keyboardShortcutService;

  @Autowired private UserRepository userRepository;

  @Autowired private UserKeyboardShortcutRepository shortcutRepository;
  ...
  void Given_validUpdate_When_updateShortcut_Then_overridePersisted() {
    ...
    KeyboardShortcutUpdateRequest request =
        new KeyboardShortcutUpdateRequest(List.of("CONTROL", "SHIFT", "P"));
