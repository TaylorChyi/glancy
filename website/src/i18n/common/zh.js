export default {
  ...
  settingsAccountUsernameSaveAction: "保存用户名",
  settingsAccountUsernameRequired: "用户名不能为空",
  settingsAccountUsernameInvalid: "用户名需由 3-20 位字母、数字或下划线组成",
  settingsAccountUsernameConflict: "该用户名已被使用",
  settingsAccountUsernameUpdateError: "保存用户名时出现问题，请稍后重试",
