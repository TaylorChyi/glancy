export default {
  ...
  refresh: "刷新",
  changeAvatar: "更换头像",
  avatarCropperTitle: "调整头像",
  avatarCropperSubtitle: "拖动图片以适配正方形框架，圈内即为展示区域。",
  avatarCropperOrientation: "请旋转至正确朝向，让面部位于中心。",
  avatarCropperZoomIn: "放大",
  avatarCropperZoomOut: "缩小",
  avatarCropperRotateLeft: "向左旋转",
  avatarCropperRotateRight: "向右旋转",
  avatarCropperZoomLabel: "缩放",
  avatarCropperRotationLabel: "旋转",
  avatarCropperPreviewAlt: "头像裁剪预览",
  avatarCropperHelper: "拖动、缩放或旋转，圆圈范围即为最终头像。",
