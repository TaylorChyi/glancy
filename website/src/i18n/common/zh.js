export default {
  ...
  responseStyleFieldGoalLabel: "个性宣言",
  responseStyleFieldGoalPlaceholder: "例如：托福 110 分",
  responseStyleFieldJobLabel: "职业角色",
  responseStyleFieldJobPlaceholder: "例如：产品经理",
  responseStyleFieldEducationLabel: "学历背景",
  responseStyleFieldEducationPlaceholder: "例如：北京大学外国语学院",
  responseStyleFieldInterestsLabel: "兴趣",
  responseStyleFieldInterestsPlaceholder: "例如：金融、设计",
