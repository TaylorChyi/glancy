export default {
  ...
  prefAccountTitle: "账户",
  avatarEditorTitle: "调整头像",
  avatarEditorInstruction: "拖动并缩放图片，圆形区域即为最终头像效果。",
  avatarEditorZoomLabel: "缩放",
  avatarEditorZoomIn: "放大",
  avatarEditorZoomOut: "缩小",
  avatarEditorCancel: "取消",
  avatarEditorConfirm: "保存头像",
  avatarEditorProcessing: "保存中…",
  avatarEditorPreparing: "正在准备预览…",
  avatarEditorError: "头像保存失败，请稍后重试。",
  avatarEditorPreviewLabel: "头像裁剪预览",
  avatarEditorPreviewAlt: "头像预览",
