export default {
  ...
  "subscription.section.title": "订阅",
  "subscription.section.description": "在此查看套餐对比、地区与兑换权益。",
  "subscription.price.free": "免费",
  "subscription.price.redeemOnly": "兑换专享",
  "subscription.price.perMonth": "{value}/月",
  "subscription.price.perYear": "{value}/年",
  "subscription.price.perYearEquivalent": "（折合 {value}/月）",
  "subscription.price.pending": "请联系客服",
  "subscription.price.premiumExpiry": "有效期至 {date}",
  "subscription.premium.perpetual": "有效期：不限期",
  "subscription.current.title": "当前订阅",
  "subscription.current.planLine": "{plan} · {cycle}",
  "subscription.billingCycle.none": "计费方式：未设置",
  "subscription.billingCycle.monthly": "月付",
  "subscription.billingCycle.yearly": "年付",
  "subscription.current.nextRenewal": "下次扣费：{date}",
  "subscription.current.renewalUnknown": "暂未安排扣费",
  "subscription.current.regionCurrency": "地区：{region} · 币种：{currency}",
  "subscription.current.regionUnknown": "地区：待确认",
  "subscription.current.currencyUnknown": "币种：待确认",
  "subscription.premium.status": "已解锁 PREMIUM 顶级权益（到期：{date}）",
  "subscription.action.manage": "管理订阅",
  "subscription.action.changePlan": "切换套餐",
  "subscription.action.changeRegion": "切换地区",
  "subscription.action.redeem": "兑换码",
  "subscription.badge.current": "当前套餐",
  "subscription.badge.selected": "已选择",
  "subscription.matrix.caption": "套餐额度与权益对比",
  "subscription.matrix.feature": "能力项",
  "subscription.redeem.title": "兑换专享权益",
  "subscription.redeem.description": "输入兑换码即可解锁 PREMIUM 权益。",
  "subscription.redeem.placeholder": "请输入兑换码（16 位）",
  "subscription.redeem.button": "立即兑换",
  "subscription.subscribe.title": "订阅",
  "subscription.subscribe.description": "确认所选套餐并前往订阅页面。",
  "subscription.subscribe.button": "前往订阅",
  "subscription.subscribe.disabled": "当前已是该套餐，无需重复订阅。",
  "subscription.faq.title": "订阅须知",
  "subscription.feature.wordLookupsDaily": "每日查词上限",
  "subscription.feature.llmCallsDaily": "AI 释义/改写（LLM）",
  "subscription.feature.ttsDaily": "TTS 发音",
  "subscription.feature.notebookCapacity": "生词本容量",
  "subscription.feature.parallelLanguages": "多语对齐例句",
  "subscription.feature.ocrPages": "OCR / 图片取词",
  "subscription.feature.pdfPages": "PDF 取词",
  "subscription.feature.concurrentRequests": "并发请求数",
  "subscription.feature.queuePriority": "队列优先级",
  "subscription.feature.queuePriority.normal": "普通",
  "subscription.feature.queuePriority.medium": "较高",
  "subscription.feature.queuePriority.high": "高",
  "subscription.feature.queuePriority.max": "最高",
  "subscription.feature.devices": "登录设备数",
  "subscription.feature.adFree": "去广告",
  "subscription.feature.switch.yes": "支持",
  "subscription.feature.switch.no": "不含",
  "subscription.feature.exports": "批量导入/导出",
  "subscription.feature.exports.free": "仅导出",
  "subscription.feature.exports.plus": "导入/导出",
  "subscription.feature.exports.pro": "导入/导出 + API 导出",
  "subscription.feature.exports.premium": "导入/导出 + API 高速导出",
  "subscription.feature.history": "历史记录保留",
  "subscription.feature.history.unlimited": "全量可检索",
  "subscription.feature.beta": "Beta 内测通道",
  "subscription.feature.beta.apply": "可申请",
  "subscription.feature.beta.default": "默认加入",
  "subscription.feature.beta.priority": "优先加入",
  "subscription.feature.support": "客服响应 SLO",
  "subscription.unit.timesPerDay": "次/天",
  "subscription.unit.entries": "条",
  "subscription.unit.languages": "种语言",
  "subscription.unit.pagesPerMonth": "页/月",
  "subscription.unit.concurrent": "并发",
  "subscription.unit.devices": "台",
  "subscription.unit.days": "天",
  "subscription.unit.hours": "小时",
  "subscription.policy.autoRenew": "除兑换获得的 PREMIUM 外，付费套餐默认自动续费，可随时关闭。",
  "subscription.policy.invoice": "订单完成后可在「订单记录」申请发票或联系支持团队。",
  "subscription.policy.refund": "如服务不可用或存在重大缺陷，可在 {days} 天内申请退款。",
  "subscription.policy.support": "如需协助，请通过客服渠道联系我们。",
  "pricing.fixedNote": "本地区价格为固定面额，不随汇率波动调整。",
  "pricing.tax.included": "价格已含税。",
  "pricing.tax.excluded": "价格不含税，可能在结算时加收税费。",
  "plan.free.title": "FREE",
  "plan.free.desc": "基础查词，含贴片广告",
  "plan.free.action": "开始使用",
  "plan.plus.title": "PLUS",
  "plan.plus.desc": "去广告 · 更高额度 · 云同步",
  "plan.plus.action": "升级至 PLUS",
  "plan.pro.title": "PRO",
  "plan.pro.desc": "OCR/PDF 取词 · 并发请求 · 专业级额度",
  "plan.pro.action": "升级至 PRO",
  "plan.premium.title": "PREMIUM",
  "plan.premium.desc": "PRO 全部 + 顶级额度与优先级 + 内测优先",
  "plan.premium.action": "已解锁",
  saving: "保存中...",
  saveButton: "保存修改",
  saveSuccess: "偏好设置已更新",
  autoDetect: "自动检测",
