export default {
  ...
  avatarCropperTitle: "Adjust avatar",
  avatarCropperSubtitle: "Drag the photo to fit the square — the circle previews the final look.",
  avatarCropperOrientation: "Rotate until your portrait faces the right direction and stays centred.",
  avatarCropperZoomIn: "Zoom in",
  avatarCropperZoomOut: "Zoom out",
  avatarCropperRotateLeft: "Rotate left",
  avatarCropperRotateRight: "Rotate right",
  avatarCropperZoomLabel: "Zoom",
  avatarCropperRotationLabel: "Rotation",
  avatarCropperPreviewAlt: "Avatar crop preview",
  avatarCropperHelper: "Drag, zoom, or rotate so the circle perfectly frames your face.",
