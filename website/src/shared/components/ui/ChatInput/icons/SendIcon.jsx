 ...
 * 目的：
 *  - 以静态资源直出方式渲染 chat-send 图标，配合按钮样式直接继承主题色，减少运行时分支。
 * 关键决策与取舍：
...
import sendButtonAsset from "@assets/chat-send.svg";
import sendButtonInline from "@assets/chat-send.svg?raw";
import { ICON_TOKEN } from "@assets/iconTokens";

import renderStaticIcon from "./renderStaticIcon.jsx";

const SEND_ICON_NAME = ICON_TOKEN.CHAT_SEND;
