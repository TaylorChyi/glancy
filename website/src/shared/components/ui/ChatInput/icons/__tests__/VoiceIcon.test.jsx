 ...
 * 目的：
 *  - 确保语音按钮渲染出可继承主题色的 inline SVG，并标记为 chat-voice，避免回退逻辑残留。
 * 关键决策与取舍：
...
jest.unstable_mockModule("@assets/chat-voice.svg", () => ({
  __esModule: true,
  default: "voice-asset.svg",
}));

jest.unstable_mockModule("@assets/chat-voice.svg?raw", () => ({
  __esModule: true,
...
describe("VoiceIcon", () => {
  ...
  test("GivenClassName_WhenRendering_ThenPreferInlinePayload", () => {
    ...
    const node = container.querySelector('[data-icon-name="chat-voice"]');
