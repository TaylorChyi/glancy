...
function VariantRow({ variant, isActive, onEnter }) {
  const handleEnter = () => onEnter(variant.key);
...
export default function LanguageVariantsColumn({ variants, activeKey, onVariantEnter, swapAction, onSwap }) {
  return (
