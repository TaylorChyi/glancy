...
| ------- | --------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------ | ------------ |
| NFR-001 | 性能      | 首个内容模块渲染完成：P95 ≤ 2.5 s；平均 ≤ 1.2 s                | 真实流量 RUM+APM（5 分钟滚动）、合成探针双口径；端/服时钟对齐；灰度与压测回归必须过线 | Must   | 1.6、16      |
...
| NFR-010 | 兼容      | 浏览器与设备兼容矩阵按[第 18 章 兼容性与客户端支持矩阵](<./第 18 章 兼容性与客户端支持矩阵.md>)执行；降级不失能               | 兼容清单通过；关键路径功能可用                               | Must   | 18           |
