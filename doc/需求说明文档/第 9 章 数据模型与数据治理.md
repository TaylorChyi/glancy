...
> **ER 图（核心实体）**：FigJam [node 230-80](https://www.figma.com/file/glancy-sdd-figjam?type=whiteboard&node-id=230-80#ERCore) / Mermaid 源 [`doc/图/src/er-core.mmd`](../图/src/er-core.mmd) / 快照 [`doc/图/export/er-core.svg`](../图/export/er-core.svg)。

![Glancy 核心 ER](../图/export/er-core.svg)
